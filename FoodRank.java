...
public class FitnessRank {
    ...
    // var1 = calories consumed, var2 = calories burned
    ...
    public void displayRank() {
        ...
        switch (rank) {
            case "Elite":
                System.out.println("Outstanding! You are at the top!");
                break;
            case "Advanced":
                System.out.println("Great work! Keep pushing forward!");
                break;
            case "Intermediate":
                System.out.println("Good progress! Stay consistent!");
                break;
            default:
                System.out.println("Keep going - every step counts!");
                break;
        }
    }
